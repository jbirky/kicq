...
mseFile  = INPATH + 'mse_samples_scales.npz'
...
plt.tight_layout()
if fitAmp == True:
	plt.savefig(os.path.join(plotDir, 'gp_bias_variance_scales_amp.png'))
else:
	plt.savefig(os.path.join(plotDir, 'gp_bias_variance_scales_noamp.png'))
plt.close()